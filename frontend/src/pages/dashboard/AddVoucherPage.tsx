...
import { CreateVoucherRequest, InputField, Variant } from "../../types";
...
const AddVoucherPage = () => {
  ...
  const handleVariantChange = (
    ...
    if (key === "price") {
      variant[key] = Number(value) as Variant[typeof key];
    } else {
      variant[key] = value as Variant[typeof key];
    }
        ...
        {form.variants.map((variant, idx) => (
          <div key={idx} className="flex gap-2 items-end mb-3">
            ...
            <button
              ...
              className="bg-red-500 text-white px-2 py-1 rounded hover:bg-red-600 h-9 cursor-pointer"
            >
              Hapus
            </button>
          </div>
