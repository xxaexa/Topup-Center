...
const VoucherPage = () => {
  ...
  return (
    <div className="p-4">
      <div className="flex flex-row justify-between items-center mb-4 gap-4">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-4 w-full md:w-1/2">
          <Input
            ...
            className="p-2 w-full md:w-auto   text-white "
          />
          <Button
            ...
            data={paginated.map((v) => [
              ...
              <div className="space-x-2">
                <button
                  ...
                  className="cursor-pointer px-3 py-1 bg-input hover:bg-button-hover text-text  rounded shadow text-sm"
                >
                  Update
                </button>
                <button
        ...
        {Array.from({ length: totalPages }).map((_, i) => (
          <button
            ...
            className={`px-3 py-1 rounded-full text-sm transition-all duration-200 shadow-sm cursor-pointer  ${
              page === i + 1 ? "bg-input text-white shadow-md" : "bg-button "
            }`}
          >
            {i + 1}
          </button>
      ...
      <div className="fixed bottom-0 left-0 right-0 md:hidden bg-input border-t border-gray-200  p-4 shadow-md ">
        <Button
          text={"Tambah Voucher"}
          onClick={handleNavigate}
          type={"button"}
